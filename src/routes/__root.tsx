...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "We eliminate the mundane, repetitive tasks eating your team's time so you can focus on what actually grows your business." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "BrightFlow AI - Fully Automate Repetitive Manual Admin" },
      { property: "og:description", content: "We eliminate the mundane, repetitive tasks eating your team's time so you can focus on what actually grows your business." },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Inter+Tight:ital,wght@0,100..900;1,100..900&family=Instrument+Serif:ital@0;1&family=JetBrains+Mono:wght@400;500;600&family=Syne:wght@500;600;700;800&family=Plus+Jakarta+Sans:ital,wght@0,300..800;1,300..800&display=swap",
      },
      {
        rel: "stylesheet",
        href: appCss,
